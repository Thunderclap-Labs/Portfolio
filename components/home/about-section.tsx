  ...
  return (
    <section className="bg-bg text-text border-b border-white/20">
      <div className="w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 px-4 sm:px-6">
          ...
          <div className="py-10.5 md:py-16 xl:py-16 border-b md:border-b-0 md:border-r border-white/20 flex flex-col justify-between md:pr-8">
            ...
            <h2 className="text-[35px] font-normal leading-[110%] tracking-[-0.7px] max-w-2xl mt-16 md:mt-0">
              Engineering critical tech for extreme environments.
            </h2>
          </div>
          
          {/* Right Column */}
          <div className="py-10.5 md:py-16 xl:py-16 flex flex-col justify-end md:pt-16 pl-0 md:pl-8">
